  ...
  kids=[
    StringFileInfo(
      ...
      StringTable(
        ...
        StringStruct(u'FileDescription', u'WatDogC service to minitor ChildGuard'),
        StringStruct(u'InternalName', u'WatchDog.exe'),
        StringStruct(u'LegalCopyright', u'by sunbeat. All rights reserved.'),
        StringStruct(u'OriginalFilename', u'WatchDog.exe'),
        StringStruct(u'ProductName', u'WatchDog Monitor'),
